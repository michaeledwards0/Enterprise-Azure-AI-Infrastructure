...
| Private DNS resolution verified | PowerShell output from inside the VNet resolving `ai-contoso-openai`'s endpoint to a private `10.1.1.5/24` address | <img width="975" height="737" alt="image" src="https://github.com/user-attachments/assets/fd28092a-352e-4593-8afd-5674f6601d7b" /> |
